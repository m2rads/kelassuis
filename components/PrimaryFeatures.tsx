                    ...
                    <div
                      ...
                      className={clsx(
                        ...
                        selectedIndex === featureIndex
                          ? 'bg-blue-900 lg:bg-blue-900/50 lg:ring-1 lg:ring-blue-900/50 lg:ring-inset'
              ...
              <TabPanels className="lg:col-span-7">
                {features.map((feature) => (
                  <TabPanel key={feature.title} unmount={false}>
                    ...
                    <div className="mt-10 w-180 overflow-hidden rounded-xl bg-white/5 shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-271.25">
                      <Image
                        className="w-full"
                        src={feature.image}
                        alt=""
